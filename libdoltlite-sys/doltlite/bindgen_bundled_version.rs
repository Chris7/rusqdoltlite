...
unsafe extern "C" {
    pub fn sqlite3_incomplete(sql: *const ::core::ffi::c_char) -> sqlite3_int64;
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn doltlite_set_chunk_source(
        db: *mut sqlite3,
        zDbName: *const ::core::ffi::c_char,
        pSource: *mut doltlite_chunk_source,
    ) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn doltlite_init_lazy(
        db: *mut sqlite3,
        pRefs: *const ::core::ffi::c_void,
        nRefs: ::core::ffi::c_int,
    ) -> ::core::ffi::c_int;
}
unsafe extern "C" {
